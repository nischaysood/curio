...
struct CurioApp: App {
    ...
    private func configureBilling() {
        ...
        // The iOS key stays blank until the App Store Connect app exists.
    ...
    private func registerBridges() {
        ...
        // Only wired when RevenueCat actually configured. Otherwise the Kotlin
        // side sees a nil bridge and treats everyone as FREE, which is correct
